...
export default function UserProfile() {
  ...
  const activity = [
    ...
    {
      id: "12921664-6ad7-447a-809e-8b08423b6bd2",
      repost: false,
  ...
  const experience = [
    ...
    },
    {
      ...
      location: "MMCOE",
      description:
        "Lorem we ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptatum.",
    },
  ];
      ...
      >
        <div className="profile-analytics flex flex-col md:pl-8 w-3/4 max-w-4xl">
          <div className="profile-card flex flex-col items-start pl-6 rounded-lg bg-white mt-8 mb-2 shadow-sm drop-shadow-sm h-fit pt-16 pb-8 border border-gray">
            ...
            <div className="profile-pic flex justify-center items-center rounded-full pb-4">
              <img
                src={user.profilePicture}
                alt=""
                className="w-36 h-36 rounded-full bg-black border-4 border-black"
              />
            </div>
            ...
            <div className="flex flex-row pt-4 justify-evenly">
              ...
              {analytics.total.search != null && (
                <div className="flex flex-row">
                  ...
                  <p className="text-md font-medium px-4">
                    {analytics.total.search} appearances
                  </p>
                </div>
              )}
            </div>

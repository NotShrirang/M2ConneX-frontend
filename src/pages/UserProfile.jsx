...
export default function UserProfile() {
  ...
  return (
    ...
    <>
      <main>
        <section>
          <div className="grid grid-cols-8 grid-rows-[70px_minmax(70px,_1fr)] gap-2 mt- max-[1060px]:w-10/12 max-[768px]:mx-auto">
            <div className="col-[2_/_span_4] row-[2_/_span_2] bg-[rgb(29,34,38)] rounded-md max-[768px]:row-[2_/_span_1] max-[768px]:col-span-8">
              ...
              <div className="mt-9 flex justify-around  flex-wrap mb-5">
                <div className="flex justify-between max-[1060px]:mx-auto w-[350px] h-[88px] border border-gray-500 rounded-md p-3 max-[1325px]:w-[250px] max-[1325px]:h-full">
                  ...
                  <p>
                    <i className="fa-sharp fa-solid fa-xmark text-white text-xl"></i>
                  </p>
                </div>
            ...
            <div className="bg-[rgb(29,34,38)] col-[2_/_span_4] row-[4_/_span_1] rounded-md max-[768px]:row-[3_/_span_1] max-[768px]:col-span-8 h-fit">
              ...
              <div>
                <h2 className="text-gray-400 ml-5">
                  ...
                  <span className="text-white font-bold -ml-9">My network</span>
                </h2>
            ...
            <div className="bg-[rgb(29,34,38)] col-[2_/_span_4] row-span-4 rounded-md max-[768px]:col-span-8 max-[768px]:row-[4_/_span_1]">
              ...
              <div className="mt-3 mb-2 ml-5">
                ...
                <button className="text-white font-medium border border-white px-2 py-1 rounded-l-full rounded-r-full ml-2">
                  Comments
                </button>
                <button className="text-white font-medium border border-white px-2 py-1 rounded-l-full rounded-r-full ml-2">
                  Articles

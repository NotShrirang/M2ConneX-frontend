...
export default function Event({ upcoming = false }) {
    return (
        <div className="w-[100%] h-[27rem] mb-[6.813rem] flex flex-row">
            <div className="w-[42%] h-[100%] mr-[5%]">
            ...
            <div className="w-[55%] h-[100%] flex flex-col">
                ...
                {upcoming &&
                    <button className="ml-[40%] w-[11rem] h-[4.375rem] text-[2.5rem] font-bold text-white rounded-md bg-lightmaroon text-center shadow-md shadow-gray ">RVSP</button>
                }
            </div>
        </div>
